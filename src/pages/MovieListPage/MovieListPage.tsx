...
const MovieListPage = () => {
    ...
    const {genreMoviesList}=useAppSelector(state => state.genresSlice);
    ...
    useEffect(() => {
        ...
        } else if (location.pathname.includes('/search/keyword')) {
    ...
    }, [dispatch, location.pathname, page, genreId, query]);
    ...
    useEffect(() => {
        ...
        } else if (location.pathname.includes('/search/keyword') && searchList) {
        ...
        setIsLoading(false);
    }, [nowPlayingList, fullList, popularList, topRatedList, upcomingList, genreMoviesList, searchList, similarList, location.pathname]);
    ...
    return (
        <div className={css.movieList}>
            ...
            <PaginationComponent
                count={listPaginatedObj.total_pages}
                page={+page}
